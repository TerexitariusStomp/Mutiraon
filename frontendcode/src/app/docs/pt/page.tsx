      ...
      <div className="container mx-auto px-4 py-10 prose prose-slate max-w-none">
        ...
        <section id="deployment">
          ...
          <ul>
            ...
            <li><code>test-*.js</code> — Fluxos completos do sistema, cenários de liquidação, simulações de keepers.</li>
            <li><code>update-price-feeds.js</code> — Atualizações/pokes de oráculos.</li>
            <li><code>verify-contracts.js</code> — Verificação em Etherscan ou explorador.</li>
          </ul>
        </section>
        ...
        <section id="subgraph">
          <h2>Subgraph</h2>
          <p>
            O The Graph indexa cofres, liquidações e métricas do protocolo. Útil para dashboards e análises.
          </p>
        </section>
        ...
        <section id="frontend">
          <h2>Frontends</h2>
          <ul>
            <li><strong>App</strong> — Interfaces de Cofres e Staking.</li>
            <li><strong>Landing</strong> — Homepage do projeto e documentação.</li>
          </ul>
        </section>
        ...
        <section id="config">
          <h2>Configuração</h2>
          <ul>
            <li>Variáveis de ambiente: RPC URL, chain ids, endpoints de faucet.</li>
            <li>Endereços de contratos: em <code>src/lib/contracts.ts</code> ou <code>src/lib/contracts-updated.ts</code>.</li>
          </ul>
        </section>
        ...
        <section id="dev">
          ...
          <h3>Dev local</h3>
          <ol>
            <li>Instale deps: <code>npm ci</code></li>
            <li>Rode o app: <code>npm run dev</code></li>
            <li>Rode Hardhat node ou use RPC Sepolia</li>
          </ol>
          ...
          <h3>Testes</h3>
          <ul>
            <li>E2E: <code>scripts/test-full-cdp.js</code>, <code>scripts/test-liquidations.js</code>, etc.</li>
        ...
        <section id="glossary">
          ...
          <ul>
            ...
            <li><strong>Line</strong> — Teto de dívida (por ilk e global).
          </ul>
        </section>
      </div>
