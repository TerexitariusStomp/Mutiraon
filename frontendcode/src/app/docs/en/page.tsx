      ...
      <div className="container mx-auto px-4 py-10 prose prose-slate max-w-none">
        ...
        <section id="deployment">
          ...
          <ul>
            ...
            <li><code>verify-contracts.js</code> — Etherscan or block explorer verification.</li>
          </ul>
        </section>
        ...
        <section id="subgraph">
          <h2>Subgraph</h2>
          <p>
            The Graph indexes vaults, liquidations, and protocol metrics. Useful for building dashboards and analytics.
          </p>
        </section>
        ...
        <section id="frontend">
          <h2>Frontends</h2>
          <ul>
            <li><strong>App</strong> — Vaults and Staking interfaces.</li>
            <li><strong>Landing</strong> — Project homepage and documentation.</li>
          </ul>
        </section>
        ...
        <section id="config">
          <h2>Configuration</h2>
          <ul>
            <li>Environment Variables: RPC URL, chain ids, faucet endpoints.</li>
            <li>Contract Addresses: stored in <code>src/lib/contracts.ts</code> or <code>src/lib/contracts-updated.ts</code>.</li>
          </ul>
        </section>
        ...
        <section id="dev">
          ...
          <ol>
            ...
            <li>Run app: <code>npm run dev</code></li>
            <li>Run Hardhat node or use Sepolia RPC</li>
          </ol>
